...
def mainwindow() :
  ...
  root.title("W6-Act created by [type your name]")
...
def menuscore():
  ...
  Entry(frm1, width=15, textvariable=midVar,justify='right').grid(row=0,column=1,pady=15,ipady=10)
  Label(frm1,text="final :").grid(row=1,column=0,pady=20,sticky='e')
  Entry(frm1, width=15, textvariable=finalVar,justify='right').grid(row=1,column=1,pady=15,ipady=10)
  Label(frm1,text="Quiz :").grid(row=2,column=0,pady=20,sticky='e')
  Entry(frm1, width=15, textvariable=quizVar,justify='right').grid(row=2,column=1,pady=15,ipady=10)
  Label(frm1,text="project :").grid(row=3,column=0,pady=20,sticky='e')
  Entry(frm1, width=15, textvariable=projVar,justify='right').grid(row=3,column=1,pady=15,ipady=10)
...
def grading() :
  ...
  Label(frame2,text=midscore).grid(row=0,column=1,pady=20,sticky='w')

  Label(frame2,text="Final :").grid(row=1,column=0,pady=20,sticky='e')
  Label(frame2,text=finalscore).grid(row=1,column=1,pady=20,sticky='w')

  Label(frame2,text="Quiz :").grid(row=2,column=0,pady=20,sticky='e')
  Label(frame2,text=quizscore).grid(row=2,column=1,pady=20,sticky='w')
  
  Label(frame2,text="project :").grid(row=3,column=0,pady=20,sticky='e')
  Label(frame2,text=projscore).grid(row=3,column=1,pady=20,sticky='w')
  showgrade = StringVar()
